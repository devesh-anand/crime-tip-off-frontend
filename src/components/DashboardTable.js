...
export function StatusPill({ value }) {
  const status = value ? value[0] : "unknown";
  ...
  return (
    <span
      className={classNames(
        ...
        status.startsWith("closed") ? "bg-yellow-100 text-yellow-800" : null
...
export function AvatarCell({ value, column, row }) {
  return (
    <div className="flex items-center">
      ...
      {/* <div className="text-sm text-gray-500">
          {row.original[column.firstNameAccessor]}{" "}
      ...
      <div className="flex-shrink-0 h-10 w-20">
        ...
        /> */}
        {/* <div className="text-sm text-gray-500">
          {row.original[column.genderAccessor]}
        </div> */}
      </div>
      <div className="ml-4">
